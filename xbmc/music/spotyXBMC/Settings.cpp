...
sp_radio_genre Settings::getRadio1Genres(){
  ...
  for(int i = 0; i < sizeof(radiogenres) / sizeof(radiogenres[0]); i++)
        if (radiogenres[i].enable)
          mask |= radiogenres[i].id;
...
sp_radio_genre Settings::getRadio2Genres(){
  ...
  struct {
    ...
    { getAddonSetting("radio2genre1") == "true",       SP_RADIO_GENRE_ALT_POP_ROCK },
    { getAddonSetting("radio2genre2") == "true",       SP_RADIO_GENRE_BLUES        },
    { getAddonSetting("radio2genre3") == "true",       SP_RADIO_GENRE_COUNTRY      },
    { getAddonSetting("radio2genre4") == "true",       SP_RADIO_GENRE_DISCO        },
    { getAddonSetting("radio2genre5") == "true",       SP_RADIO_GENRE_FUNK         },
    { getAddonSetting("radio2genre6") == "true",       SP_RADIO_GENRE_HARD_ROCK    },
    { getAddonSetting("radio2genre7") == "true",       SP_RADIO_GENRE_HEAVY_METAL  },
    { getAddonSetting("radio2genre8") == "true",       SP_RADIO_GENRE_RAP          },
    { getAddonSetting("radio2genre9") == "true",       SP_RADIO_GENRE_HOUSE        },
    { getAddonSetting("radio2genre10") == "true",       SP_RADIO_GENRE_JAZZ         },
    { getAddonSetting("radio2genre11") == "true",       SP_RADIO_GENRE_NEW_WAVE     },
    { getAddonSetting("radio2genre12") == "true",       SP_RADIO_GENRE_RNB          },
    { getAddonSetting("radio2genre13") == "true",       SP_RADIO_GENRE_POP          },
    { getAddonSetting("radio2genre14") == "true",       SP_RADIO_GENRE_PUNK         },
    { getAddonSetting("radio2genre15") == "true",       SP_RADIO_GENRE_REGGAE       },
    { getAddonSetting("radio2genre16") == "true",       SP_RADIO_GENRE_POP_ROCK     },
    { getAddonSetting("radio2genre17") == "true",       SP_RADIO_GENRE_SOUL         },
    { getAddonSetting("radio2genre18") == "true",       SP_RADIO_GENRE_TECHNO       },
  };
  int mask = 0;
  for(int i = 0; i < sizeof(radiogenres) / sizeof(radiogenres[0]); i++)
        if (radiogenres[i].enable)
